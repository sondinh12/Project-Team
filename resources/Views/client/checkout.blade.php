...
@section('content')
<form action="<?=$_ENV['BASE_URL'] . 'placeorder'?>" method="post">
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Name</label>
                            <input class="form-control" type="text" value="{{$info['name']}}">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
            ...
            <div class="col-lg-4">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        @foreach ($productsSelect as $productSelectItem)
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <button class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3" type="submit" name="btn_placeorder">Place Order</button>
                    </div>
                </div>
            </div>
        </div>
