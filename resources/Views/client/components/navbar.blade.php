            ...
            <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                <div class="navbar-nav w-100 overflow-auto" style="max-height: 410px;">
                    @foreach ($categories as $cate) 
                        <a href="{{$cate['id_category']}}" class="nav-item nav-link">{{$cate['category_name']}}</a>
                    @endforeach 
                </div>
            </nav>
        </div>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        <a href="<?=$_ENV['BASE_URL'] . 'home'?>" class="nav-item nav-link active">Home</a>
            ...
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" style="height: 410px;">
                        <img class="img-fluid" src="<?=$_ENV['BASE_URL']?>uploads/products/1744968089_71RyGsKr3CL.jpg" alt="Image">
                    ...
                    <div class="carousel-item" style="height: 410px;">
                        <img class="img-fluid" src="<?=$_ENV['BASE_URL']?>uploads/products/1744969366_dell_inspiron_15_i15rv_6144blk_15_6_986169.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order
                                </h4>
